Feature: Bookcategory
  ...
  Scenario Outline: I should be able to see book page with filters
    ...
    Then I should be navigted to book category
  ...
  Scenario Outline: I should be able to choose any filter option with specific result
    ...
    Then  I should be able to choose filter option frim the list
    ...
    Examples:
      ...
      | Display | Created on        | Recently added product should show first                          |
  ...
  Scenario Outline: I should be able to see product display format according display format type as per given in srs document
    ...
    Then  I should be able to see product display format accordig display format type as per given picture in SRS document
    Examples:
      | display format icon |
      | Grid                |
      | List                |
